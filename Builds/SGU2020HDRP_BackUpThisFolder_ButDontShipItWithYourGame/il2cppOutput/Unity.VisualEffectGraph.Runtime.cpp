...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR int32_t ExposedProperty_op_Implicit_m18DE6FCAB257E7CB7B99E16A18CE224380195099 (ExposedProperty_t57A28BBF6D81E8D9F35EF7BCBB758B521E1B0577 * ___parameter0, const RuntimeMethod* method)
{
	...
	}
	{
		...
		InvalidOperationException__ctor_mC012CE552988309733C896F3FEA8249171E4402E(L_5, _stringLiteral1206BF0E339ECCEEF9BF321F277DB0FA5C3D3888, /*hidden argument*/NULL);
		IL2CPP_RAISE_MANAGED_EXCEPTION(L_5, ExposedProperty_op_Implicit_m18DE6FCAB257E7CB7B99E16A18CE224380195099_RuntimeMethod_var);
	}
...
IL_0020:
	...
	}
	{
		...
		int32_t L_11 = Shader_PropertyToID_m8C1BEBBAC0CC3015B142AF0FA856495D5D239F5F(L_10, /*hidden argument*/NULL);
		NullCheck(L_8);
		L_8->set_m_Id_1(L_11);
	}
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void VFXBinderBase_OnDisable_mD4319DF68CD63205BC71017AEF8F546945D1DD15 (VFXBinderBase_t4E7B86F5FA583E3372139BE1AF6A2AAC1C06C4AD * __this, const RuntimeMethod* method)
{
	...
	}
	{
		...
		List_1_t91DD73665E6BF8A9D235DD5C3F76A503184A1802 * L_4 = L_3->get_m_Bindings_5();
		NullCheck(L_4);
		List_1_Remove_m5E7B7735190D4A1D2A4EE609D21DBFF6BE710D02(L_4, __this, /*hidden argument*/List_1_Remove_m5E7B7735190D4A1D2A4EE609D21DBFF6BE710D02_RuntimeMethod_var);
	}
...
IL_001b:
	{
		...
		int32_t L_4 = V_0;
		NullCheck(L_3);
		VFXBinderBase_t4E7B86F5FA583E3372139BE1AF6A2AAC1C06C4AD * L_5 = List_1_get_Item_mB9501A53AA026CCD393ECEB536029F9D5EB44A99_inline(L_3, L_4, /*hidden argument*/List_1_get_Item_mB9501A53AA026CCD393ECEB536029F9D5EB44A99_RuntimeMethod_var);
		V_1 = L_5;
		// if (binding == null)
	...
	}
	{
		...
		String_t* L_13 = String_Format_m8D1CB0410C35E052A53AE957C914C841E54BAB66(_stringLiteral68E5CEC31382AB192FF06E62F708EC196A878699, L_10, L_12, /*hidden argument*/NULL);
...
IL_0053:
	{
		...
		NullCheck(L_14);
		bool L_16 = VirtFuncInvoker1< bool, VisualEffect_t7C6E2AAA4DB4F47960AF2029EA96D4B579B3A4CA * >::Invoke(4 /* System.Boolean UnityEngine.VFX.Utility.VFXBinderBase::IsValid(UnityEngine.VFX.VisualEffect) */, L_14, L_15);
		if (!L_16)
		{
			goto IL_006d;
		}
...
IL_0071:
	{
		...
		NullCheck(L_21);
		int32_t L_22 = List_1_get_Count_m35A71CA7B83D420724389D4EFCBDE693EF4385FE_inline(L_21, /*hidden argument*/List_1_get_Count_m35A71CA7B83D420724389D4EFCBDE693EF4385FE_RuntimeMethod_var);
